...
$(function(){
    ...
    function getALLUser() {
        ...
        // xhr.open("get","/getLanJiaZai.do?itemNum="+itemNum);
        xhr.open("get","/getLanJiaZai.do");
        xhr.send(null)
    }
            ...
            (function(sqlJson){
                ...
                if(itemNum>30){
                    ...
                    // for(var i=0;i<sqlJson.length;i++){
                        ...
                        html+="<li class='item'>" +
                                "<a href='#' class='a-img'>"+
                                    "<img src="+sqlJson[i].c_img+" alt=''>" +
                                "</a>" +
                                "<h2 class='li-title' title=''></h2>" +
                                "<p class='description'>"+sqlJson[i].c_text+"</p>" +
                                "<div class='qianm clearfloat'>" +
                                    "<div class='info'>" +
                                            "<div class='userImg'>" +
                                                "<img src="+sqlJson[i].u_img+" alt=''>" +
                                             "</div>" +
                                            "<div class='userInfo'>" +
                                                "<p>"+sqlJson[i].u_name+"</p>" +
                                                "<p>"+sqlJson[i].a_sheng+"</p>" +
                                            "</div>" +
                                            "<div class='imgNum'>" +
